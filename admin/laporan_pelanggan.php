...
<div id="print">
	...
	<a style="margin-bottom:10px" href="cetakpelanggan.php" target="_blank" class="btn btn-success pull-right"><span class='glypicon glypicon-print'></span> Cetak Laporan</a>